...
% \noindent For a silicate particle impacting 6061, we have
% \begin{align*}
% t_b &= 0.2 * 0.1 * (0.5 / 2.7) = 0.004 cm \\
% t_w &= 0.16 (0.1)^{0.5} \left( 0.5 * 2.7 \right)^{1/6} \left( 0.5 * \dfrac{4}{3} * \pi (0.1/2)^3 \right)^{1/3} 23 / (10.2)^{0.5} \left( 70/ 57 \right)^{0.5} = 0.027 cm
% \end{align*}
% \noindent For a silicate particle impacting 7075, we have
% \begin{align*}
% t_b &= 0.2 * 0.1 * (0.5 / 2.81) = 0.004 cm \\
% t_w &= 0.16 (0.1)^{0.5} \left( 0.5 *  2.81 \right)^{1/6} \left( 0.5 * \dfrac{4}{3} * \pi (0.1/2)^3 \right)^{1/3} 23 / (10.2)^{0.5} \left( 70/ 57 \right)^{0.5} = 0.027 cm
% \end{align*}
% \noindent For a steel particle impacting 6061, we have
% \begin{align*}
% t_b &= 0.2 * 0.1 * (7.8 / 2.7) = 0.058 cm \\
% t_w &= 0.16 (0.1)^{0.5} \left( 7.8 * 2.7 \right)^{1/6} \left( 7.8 * \dfrac{4}{3} * \pi (0.1/2)^3 \right)^{1/3} 7 / (10.2)^{0.5} \left( 70/ 57 \right)^{0.5} = 0.107 cm
% \end{align*}
% \noindent For a steel particle impacting 7075, we have
% \begin{align*}
% t_b &= 0.2 * 0.1 * (7.8 / 2.81) = 0.055 cm \\
% t_w &= 0.16 (0.1)^{0.5} \left( 7.8 * 2.81 \right)^{1/6} \left( 7.8 * \dfrac{4}{3} * \pi (0.1/2)^3 \right)^{1/3} 7 / (10.2)^{0.5} \left( 70/ 57 \right)^{0.5} = 0.108 cm
% \end{align*}
\begin{table}[h]
\begin{center}
\begin{tabular}{r|rr}
